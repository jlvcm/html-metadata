...
exports.parseAll = function(chtml){
	...
	const metadata = {};
	// Array of metadata of each type in exports.metadataFunctions
	keys.forEach(function(key) {
		try {
			metadata[key] = exports.metadataFunctions[key](chtml);
		} catch(e) {}
	});
...
exports.parseCOinS = function(chtml){
	...
	tags.each(function() {
		...
		results.push(exports.parseCOinSTitle(title));
	});
 ...
 */
 exports.parseCOinSTitle = function(title){
		...
		if (typeof title !== 'string'){
			throw new Error('Provided value must be a string; Got ' + typeof title);
		}
		...
		if (!Object.keys(metadata).length){
			throw new Error('No COinS in provided string');
		}
 ...
 * @param  {Object}   chtml html Cheerio object
 * @return {Object}         EPrints metadata
 */
exports.parseEprints = function(chtml){

	const parsed = exports.parseBase(
		chtml,
		['meta'],
	...
	if (parsed.type){
		parsed.type = parsed.type.toLowerCase(); // Standardise 'type' field to lowercase
	}
	return parsed;
 ...
 * @param  {Object}   chtml html Cheerio object
 * @return {Object}         general metadata
 */
